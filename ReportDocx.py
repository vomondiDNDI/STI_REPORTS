...
records = [
    ...
    [3,  'Cod confit', '2.75'],
    [4,   'Mbagathi Health Centre', '50'],
    [5,   'Special Treatment Centre Casino Health Centre', '70']
]
...
hdr_cells[0].text = 'ID' #first row text/heading
...
#doc.save('C:\\Users\\vomondi\OneDrive - Drugs for Neglected Diseases Initiative\\Bureau\\STI MONTHLY REPORT\output_folder\\first.doc')
...
run =p1.add_run('DNDi-MILT/PM-01-VL')
run.italic = False
run.bold = False
font = run.font
font.name = 'Calibri'
